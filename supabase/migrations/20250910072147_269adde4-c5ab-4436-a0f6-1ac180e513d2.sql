-- Add sample data with correct society_units schema
...
-- Insert sample locations with correct column names
...
-- Insert sample society units with correct columns
INSERT INTO society_units (id, building_id, unit_number, unit_type, carpet_area, status)
VALUES 
  ('880e8400-e29b-41d4-a716-446655440001', '770e8400-e29b-41d4-a716-446655440001', 'A101', '2bhk', 850.00, 'available'),
  ('880e8400-e29b-41d4-a716-446655440002', '770e8400-e29b-41d4-a716-446655440001', 'A102', '3bhk', 1200.00, 'available'),
  ('880e8400-e29b-41d4-a716-446655440003', '770e8400-e29b-41d4-a716-446655440002', 'B201', '2bhk', 900.00, 'available')
ON CONFLICT (id) DO NOTHING;
