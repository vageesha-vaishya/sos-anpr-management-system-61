...
-- Test Organizations (using correct column names)
INSERT INTO organizations (id, name, organization_type, subscription_plan, contact_email, is_active, created_at, updated_at) VALUES 
