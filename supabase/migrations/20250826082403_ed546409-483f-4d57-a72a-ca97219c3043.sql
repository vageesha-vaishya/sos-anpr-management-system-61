-- Fix foreign key relationships and add sample data for financial management (all enums fixed)
...
-- Insert ANPR service charges with correct service_type and status
...
-- Insert additional ANPR service charges for different service types
INSERT INTO anpr_service_charges (customer_id, service_type, charge_amount, unit_price, quantity, billing_date, billing_period_start, billing_period_end, status)
SELECT 
    bc.id,
