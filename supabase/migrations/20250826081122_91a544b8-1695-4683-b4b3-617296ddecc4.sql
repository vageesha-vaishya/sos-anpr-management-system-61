-- Fix foreign key relationships and add sample data for financial management (corrected)
...
-- Insert sample society units (using correct column names)
INSERT INTO society_units (organization_id, unit_number, unit_type, owner_name, tenant_name, area_sqft, monthly_rate_per_sqft, monthly_flat_rate, parking_slots, status) VALUES
('00000000-0000-0000-0000-000000000001', 'A-101', '2BHK', 'John Smith', NULL, 850.0, 3.00, 2550.00, 1, 'occupied'),
('00000000-0000-0000-0000-000000000001', 'A-102', '3BHK', 'Mary Johnson', 'David Brown', 1200.0, 2.92, 3500.00, 2, 'occupied'),
('00000000-0000-0000-0000-000000000001', 'B-201', '2BHK', 'Robert Wilson', NULL, 900.0, 3.11, 2800.00, 1, 'occupied'),
('00000000-0000-0000-0000-000000000001', 'B-202', '1BHK', 'Lisa Anderson', NULL, 600.0, 3.33, 2000.00, 1, 'vacant'),
('00000000-0000-0000-0000-000000000001', 'C-301', '3BHK', 'Michael Davis', 'Sarah Miller', 1300.0, 3.08, 4000.00, 2, 'occupied');
