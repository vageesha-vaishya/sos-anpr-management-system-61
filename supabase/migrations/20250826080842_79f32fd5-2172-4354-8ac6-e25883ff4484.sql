...
-- Add advertiser_id to billing_customers to link advertisers
...
INSERT INTO society_units (organization_id, unit_number, unit_type, floor, building_name, carpet_area, built_up_area, owner_name, owner_contact, tenant_name, tenant_contact, occupancy_status, maintenance_rate, parking_spaces, is_active) VALUES
('00000000-0000-0000-0000-000000000001', 'A-101', '2BHK', 1, 'Tower A', 850.0, 1100.0, 'John Smith', '+91-9876543210', NULL, NULL, 'owner_occupied', 2500.00, 1, true),
('00000000-0000-0000-0000-000000000001', 'A-102', '3BHK', 1, 'Tower A', 1200.0, 1500.0, 'Mary Johnson', '+91-9876543211', 'David Brown', '+91-9876543212', 'tenant_occupied', 3500.00, 2, true),
('00000000-0000-0000-0000-000000000001', 'B-201', '2BHK', 2, 'Tower B', 900.0, 1150.0, 'Robert Wilson', '+91-9876543213', NULL, NULL, 'owner_occupied', 2800.00, 1, true),
('00000000-0000-0000-0000-000000000001', 'B-202', '1BHK', 2, 'Tower B', 600.0, 750.0, 'Lisa Anderson', '+91-9876543214', NULL, NULL, 'vacant', 2000.00, 1, true),
('00000000-0000-0000-0000-000000000001', 'C-301', '3BHK', 3, 'Tower C', 1300.0, 1600.0, 'Michael Davis', '+91-9876543215', 'Sarah Miller', '+91-9876543216', 'tenant_occupied', 4000.00, 2, true);
...
-- Insert sample camera subscriptions
...
WHERE customer_type = 'advertiser';
