...
USING (
  ...
  AND get_user_role() = ANY(ARRAY['platform_admin'::user_role, 'franchise_admin'::user_role, 'customer_admin'::user_role, 'society_president'::user_role, 'property_manager'::user_role])
);
