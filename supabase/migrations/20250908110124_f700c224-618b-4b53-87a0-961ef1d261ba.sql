-- Create sample charge categories (charge_categories table has correct structure)
...
-- Create sample service types (using correct column names: service_name, service_category, default_rate, etc.)
INSERT INTO service_types (service_name, description, service_category, default_rate, unit_type, billing_model, organization_id) VALUES
('Plumbing Repair', 'Basic plumbing repair services', 'maintenance', 500.00, 'per_hour', 'fixed', '00000000-0000-0000-0000-000000000001'),
('Electrical Work', 'Electrical repair and installation', 'maintenance', 800.00, 'per_hour', 'fixed', '00000000-0000-0000-0000-000000000001'),
('Housekeeping', 'Professional cleaning services', 'cleaning', 300.00, 'per_visit', 'fixed', '00000000-0000-0000-0000-000000000001'),
('Pest Control', 'Pest control and fumigation', 'health', 1200.00, 'per_visit', 'fixed', '00000000-0000-0000-0000-000000000001'),
('AC Service', 'Air conditioner service and repair', 'maintenance', 1000.00, 'per_unit', 'fixed', '00000000-0000-0000-0000-000000000001'),
('Painting', 'Interior and exterior painting', 'maintenance', 50.00, 'per_sqft', 'variable', '00000000-0000-0000-0000-000000000001'),
('Security Guard', 'Security guard services', 'security', 1500.00, 'per_day', 'recurring', '00000000-0000-0000-0000-000000000001'),
('Garbage Collection', 'Waste collection and disposal', 'cleaning', 200.00, 'per_visit', 'fixed', '00000000-0000-0000-0000-000000000001');

-- Create sample service types for franchise organization  
INSERT INTO service_types (service_name, description, service_category, default_rate, unit_type, billing_model, organization_id) VALUES
('Plumbing Service', 'Professional plumbing services', 'maintenance', 600.00, 'per_hour', 'fixed', '98a21b23-27dd-4bbe-b03e-051a324b8256'),
('Electrical Service', 'Electrical maintenance', 'maintenance', 900.00, 'per_hour', 'fixed', '98a21b23-27dd-4bbe-b03e-051a324b8256'),
('Cleaning Service', 'Deep cleaning services', 'cleaning', 400.00, 'per_visit', 'fixed', '98a21b23-27dd-4bbe-b03e-051a324b8256'),
('Security Service', 'Professional security', 'security', 1800.00, 'per_day', 'recurring', '98a21b23-27dd-4bbe-b03e-051a324b8256');

-- Create sample amenities (getting building IDs and associating them)
