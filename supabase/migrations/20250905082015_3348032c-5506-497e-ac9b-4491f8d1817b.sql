...
INSERT INTO organizations (id, name, organization_type, description, created_at) VALUES
('00000000-0000-0000-0000-000000000000', 'Sample Society', 'customer', 'Demo society for testing purposes', now())
ON CONFLICT (id) DO NOTHING;

-- Now add sample data for testing critical fixes
