-- Add sample data with correct schema structure
...
-- Update existing profiles with phone numbers (using correct phone field)
UPDATE profiles 
SET phone = CASE 
...
-- Insert sample profiles using correct role enum values
